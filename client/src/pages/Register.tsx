...
import { z } from 'zod';
import { PenTool, Mail, Lock, User, Loader2, FileText, Shield, Zap } from 'lucide-react';
...
const Register = () => {
    ...
    const onSubmit = async (data: RegisterFormValues) => {
        ...
        try {
            ...
            login(token, user);
            toast('success', `Welcome to SignVault, ${user.name}!`);
            navigate('/dashboard');
        } catch (err: any) {
            ...
            <div style={{
                ...
                <div className="animate-fade-in" style={{ position: 'relative', zIndex: 1 }}>
                    ...
                    <h2 style={{ fontSize: 32, fontWeight: 800, lineHeight: 1.2, marginBottom: 16, letterSpacing: -0.5 }}>
                        Start signing<br />today.
                    </h2>
                    <p style={{ fontSize: 16, color: 'var(--sidebar-text-light)', lineHeight: 1.7, marginBottom: 40 }}>
                        Create your free account and begin managing documents with digital signatures.
                    </p>
            ...
            <div style={{
                ...
                <div style={{ width: '100%', maxWidth: 420 }} className="animate-fade-in-up">
                    <div style={{ textAlign: 'center', marginBottom: 32 }}>
                        ...
                        <h2 style={{ fontSize: 24, fontWeight: 700, color: 'var(--gray-900)', marginBottom: 4 }}>Create your account</h2>
                        <p style={{ fontSize: 14, color: 'var(--gray-500)' }}>Get started with SignVault today</p>
                    </div>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                            <div>
                                ...
                                <div className="input-with-icon">
                                    ...
                                    <input {...reg('name')} className="input-field" placeholder="John Doe" />
                                </div>
                            ...
                            <div>
                                ...
                                <div className="input-with-icon">
                                    ...
                                    <input {...reg('email')} type="email" className="input-field" placeholder="you@example.com" />
                                </div>
                            ...
                            <div>
                                ...
                                <div className="input-with-icon">
                                    ...
                                    <input {...reg('password')} type="password" className="input-field" placeholder="Min. 6 characters" />
                                </div>
                    ...
                    <p style={{ textAlign: 'center', marginTop: 24, fontSize: 14, color: 'var(--gray-500)' }}>
                        ...
                        <Link to="/login" style={{ color: 'var(--accent-500)', fontWeight: 600, textDecoration: 'none' }}>
                            Sign in
                        </Link>
                    </p>
                </div>
